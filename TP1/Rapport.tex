...
\begin{document}
	...
	\chapter{Test des coutils}
		\section{vmstat}
			...
			\img{vmstat1}{Sortie vmstat au lancement d'Eclipse}{0.5}
		...
		\section{iostat}
			...
			\img{iostat1}{iostat avec Eclipse ouvert}{0.5}
		...
		\section{JConsole}
			...
			\begin{figure}[H]
				\begin{minipage}{0.49\textwidth}
					\img{jconsole1}{Eclipse en fond (vue générale)}{0.25}
				\end{minipage}
				\begin{minipage}{0.49\textwidth}
					\img{jconsole2}{Eclipse en fond (Mémoire heap)}{0.25}
				\end{minipage}
			\end{figure}
		...
		\section{JHat}
			...
			\img{jhat1}{Toutes les classes}{0.4}
			\img{jhat2}{Détails d'une classe}{0.4}
		...
		\section{Java Mission Control}
			...
			\img{jmc2}{Plugin GC de Java Mission Control}{0.3}
\end{document}